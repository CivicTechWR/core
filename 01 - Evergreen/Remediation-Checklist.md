...
- [ ] **Re-audit, per pillar.** Once per season, at the finale — each pillar re-audits its own Process Index section rather than one person re-auditing all 68. Tracked as [Theme: Season re-audit](https://github.com/CivicTechWR/core/issues/24) on Project 47. Method is on [[Editing-These-Docs]].
